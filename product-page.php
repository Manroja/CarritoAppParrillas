    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <a class="nav-link waves-effect" href="home-page.html">Inicio
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <img src="img/parrilla1.jpg" class="img-fluid" alt="">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <div class="mb-3">
              <a href="">
                <span class="badge purple mr-1">Alquiler</span>
              </a>
              <a href="">
                <span class="badge blue mr-1">Nuevo</span>
              </a>
              <a href="">
                <span class="badge red mr-1">Precio Especial</span>
              </a>
            </div>
            ...
            <p>Increíble Parrilla Char Broil</p>
...
<!--Grid row-->
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <img src="img/chef.jpg" class="img-fluid" alt="">
